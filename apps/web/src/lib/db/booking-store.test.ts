...
describe('booking-store invariants', () => {
  ...
  it('confirms only unexpired holds and writes ticket plus seats atomically', async () => {
    ...
    expect(statement).toContain("'conversationid', $10::text")
    expect(statement).toContain("'passengername', $11::text")
    expect(statement).toContain("'phone', $12::text")
    expect(statement).toContain("'conversationid', $14::text")
