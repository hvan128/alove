...
export function getPublicIntegrationStatus(
  ...
  return {
    ...
    valsea,
    voiceAgent,
    persistence: Boolean(nonEmpty(environment.DATABASE_URL)) || environment.OPERATOR_DEMO_MODE === 'true',
    operatorDemo: environment.OPERATOR_DEMO_MODE === 'true',
    localFallback: true,
  }
}
