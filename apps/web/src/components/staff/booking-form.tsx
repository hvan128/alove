...
export function BookingForm({ booking, onEdit, seatPicker }: Props) {
  return (
      ...
      <div className="space-y-6 p-4">
        ...
        <FieldGroup title="Chuyến và ghế">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            {booking.runtimeProfile === 'durable'
              ? seatPicker ?? <p className="rounded-[12px] bg-[var(--warning-soft)] p-3 text-xs text-[var(--warning)]">Chọn chuyến và số khách để mở sơ đồ ghế.</p>
