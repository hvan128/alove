...
describe('durable booking references', () => {
  it('requires authoritative references for durable confirmed drafts', () => {
    const result = bookingDraftSchema.safeParse({
      id: 'booking-DEMO42', conversationId: 'DEMO42', status: 'confirmed',
      runtimeProfile: 'durable', catalogVersionId: null, tripId: null, seatHoldId: null,
      origin: 'Sài Gòn', destination: 'Đà Lạt', travelDateLabel: '24/07/2026', timeWindow: '22:00',
      passengerCount: 1,
      selectedTrip: {
      ...
      pickupPoint: 'Bến xe', dropoffPoint: 'Đà Lạt', vehiclePreference: null, paymentMethod: null, note: null,
      totalFareVnd: 320000, bookingCode: 'VD-001', evidenceMessageIds: ['message-1'],
      fieldEvidence: {}, confirmedFields: [], reviewItems: [],
    })
